...
def main():
    ...
    #     [Image, 'Image', FLAG_FILE],
    #       ...
    for list_file, name_folder, flag in list_folders:
        print(f"{name_folder}: {print_list(list_file)}")

        for file in list_file:
            if flag == FLAG_FILE:
                handle_file(file, folder_path, name_folder)
            elif flag == FLAG_ARCHIVES:
                handle_archive(file, folder_path, name_folder)
